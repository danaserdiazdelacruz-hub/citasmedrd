...
export const TOOL_DEFINITIONS = [
  ...
  {
    name: "agendar_cita",
    description: "Agenda una cita médica. SOLO úsala cuando tengas TODOS los datos confirmados: doctor_clinica_id, horario (inicia_en), nombre completo, teléfono (10 dígitos) y motivo. NUNCA la uses sin tener todos los datos. La cédula es OPCIONAL — solo pídela si el paciente la ofrece voluntariamente o si la sede la requiere para seguro/facturación.",
    input_schema: {
      type: "object" as const,
      properties: {
        doctor_clinica_id: { type: "string", description: "UUID de la relación doctor-clínica" },
        ...
        cedula: { type: "string", description: "OPCIONAL. Cédula dominicana formato 000-0000000-0 o 11 dígitos seguidos. Se valida automáticamente." },
      },
