...
export function saludoConCitaPendiente(
  ...
  return pick([
    `👋 ¡Hola de nuevo! Te tengo registrado con cita en *${nombreClinica}*:\n\n📅 *${servicio}*\n🕒 ${fechaHora}\n\n¿En qué te ayudo?`,
    `¡Hola! 😊 Veo que ya tienes una cita con nosotros:\n\n📅 *${servicio}* — ${fechaHora}\n\n¿Qué necesitas?`,
    `Hola otra vez 🙌 Tu próxima cita con *${nombreClinica}* es:\n📅 ${servicio} — ${fechaHora}\n\n¿Cómo te ayudo hoy?`,
  ]);
}
